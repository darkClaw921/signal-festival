...
pitched_audio = change_pitch(audio, semitones=5)  # Увеличиваем высоту на 5 полутонов

# Добавление реверберации
reverb_audio = add_reverb(pitched_audio, decay=0.6)

# Добавление эха
alien_voice_with_echo = add_echo(reverb_audio, delay=200, decay=0.5)

# Сохранение результата
alien_voice_with_echo.export("alien_voice_with_echo.mp3", format="mp3")

# Воспроизведение результата (опционально)
play(alien_voice_with_echo)
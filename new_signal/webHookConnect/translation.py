...
if __name__ == '__main__':
    ...
    # text_example = "И любая возможность в обычной жизни вызывает у вас это чувство воспоминания о смерти Поэтому каждая штука в вашей жизни, каждая события, даже самые маленькие события, не такие важные, скажем так, как экзамен в университете или в школе Становится для вас вопросом жизни и смерти Потому что вы знаете результат этого состояния, вы знаете результат этого ожидания И ваша осознанность подсказывает вам"
